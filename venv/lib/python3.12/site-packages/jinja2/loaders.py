...
class DictLoader(BaseLoader):
    ...
    >>> loader = DictLoader({'homepage.html': 'source here'})
...
class PrefixLoader(BaseLoader):
    ...
    By loading ``'app1/homepage.html'`` the file from the app1 package is loaded,
    by loading ``'app2/homepage.html'`` the file from the second.
    """
